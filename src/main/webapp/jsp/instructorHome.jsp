...
<html>
<head>
    <title>Instructor Home - Driving School</title>
...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-md rounded-lg p-6 max-w-2xl mx-auto">
        ...
        <p class="text-lg mb-4">You are logged in as an <span class="font-semibold">Instructor</span>.</p>
        <div id="userDetails" class="mb-4 text-gray-700" style="display: block; min-height: 100px; border: 1px solid blue;"></div>
        <div class="space-y-4">
            <a href="<%= request.getContextPath() %>/scheduleLesson?action=calendar" class="block bg-blue-500 text-white p-2 rounded-md text-center hover:bg-blue-600">View Schedule</a>
