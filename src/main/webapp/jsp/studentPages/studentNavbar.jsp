<nav class="bg-blue-500 text-white shadow-md">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div class="space-x-4">
            ...
            <a href="<%= request.getContextPath() %>/payment?action=history&studentId=<%= ((com.Model.User) session.getAttribute("loggedInUser")).getId() %>" class="hover:bg-blue-600 px-3 py-2 rounded-md transition duration-200">Payments</a>
